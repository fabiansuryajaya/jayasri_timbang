            ...
            <div class="card full-height">
                <div class="card-body">
                    <div class="page-header">
                        <h4 class="page-title">Transaksi Penjualan</h4>
                    </div>
                    <div class="table-responsive">
                        <table id="table-2" class="display table table-striped table-hover">
                            ...
                            <tfoot>
                                <th colspan="9"><center>Total</center></th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th colspan="2"></th>
        ...
        $(document).ready(function () {
            tabel = $('#table-2').dataTable({
                ...
                "buttons": [
                    {
                        extend: 'excelHtml5',
                        title: 'Transaksi Penjualan ' + (tgl1 ?? '') + ' - ' + (tgl2 ?? ''),
                ...
                "footerCallback": function (row, data, start, end, display) {
                    var api = this.api();
                    // Function to remove commas and convert to a number
                    ...
                    // Update footer
                    $(api.column(9).footer()).html(totalNetto.toLocaleString());
                    $(api.column(10).footer()).html(totalHargaJual.toLocaleString());
                    $(api.column(11).footer()).html(totalHargaPokok.toLocaleString());
                    $(api.column(12).footer()).html(totalProfit.toLocaleString());
                }
            });
